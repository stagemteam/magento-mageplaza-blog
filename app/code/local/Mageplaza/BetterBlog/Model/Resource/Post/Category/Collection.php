 ...
 * @author      Sam
 */
class Mageplaza_BetterBlog_Model_Resource_Post_Category_Collection extends Mageplaza_BetterBlog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('mageplaza_betterblog/post_category')),
