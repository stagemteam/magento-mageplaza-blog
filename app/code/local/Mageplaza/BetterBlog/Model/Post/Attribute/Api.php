 ...
 */
/**
 * Post attribute API model
 *
 * @category    Mageplaza
 * @package     Mageplaza_BetterBlog
 * @author      Sam
 */
class Mageplaza_BetterBlog_Model_Post_Attribute_Api extends Mage_Catalog_Model_Api_Resource
{
    /**
     * Post entity type id
     *
    ...
    {
        $this->_storeIdSessionField = 'post_store_id';
        $this->_entityTypeId = Mage::getModel('eav/entity')->setType('mageplaza_betterblog_post')
            ->getTypeId();
    }
    ...
    public function items()
    {
        ...
        foreach ($attributes as $attribute) {
            if ($this->_isAllowedAttribute($attribute)) {
                if (!$attribute->getId() || $attribute->getIsGlobal() == Mageplaza_BetterBlog_Model_Attribute::SCOPE_GLOBAL) {
                    $scope = 'global';
    ...
    public function options($attributeId, $store = null)
    {
        ...
        $attribute = Mage::getModel('mageplaza_betterblog/post')
            ->setStoreId($storeId)
            ->getResource()
    ...
    {
        $model = Mage::getResourceModel('mageplaza_betterblog/eav_attribute')
