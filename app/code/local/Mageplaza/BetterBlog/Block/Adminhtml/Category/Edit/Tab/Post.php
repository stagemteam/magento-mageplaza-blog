 ...
 * @author      Sam
 */
class Mageplaza_BetterBlog_Block_Adminhtml_Category_Edit_Tab_Post extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Mageplaza_BetterBlog_Block_Adminhtml_Category_Edit_Tab_Post
     * @author Sam
     */
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('related' => $collection->getTable('mageplaza_betterblog/category_post')),
