 ...
 * @author      Sam
 */
class Mageplaza_BetterBlog_Block_Adminhtml_Post_Edit_Tab_Category extends Mageplaza_BetterBlog_Block_Adminhtml_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('mageplaza_betterblog/post/edit/tab/category.phtml');
    }
    ...
    public function buildNodeName($node)
    {
        ...
        $result .= '<a target="_blank" href="'.
            $this->getUrl(
                'adminhtml/betterblog_category/index',
                array(
                    'id'    => $node->getId(),
                    'clear' => 1
                )
